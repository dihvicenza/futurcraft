...
- Developed by [Digital Innovation Hub](https://digitalinnovationhubvicenza.it/) of Confartigianato Vicenza
- Read more on [Confartigianato Vicenza - FuturCRAFT](https://www.confartigianatovicenza.it/futurcraft/)
...
- Entwickelt von [Digital Innovation Hub](https://digitalinnovationhubvicenza.it/) von Confartigianato Vicenza
- Lesen Sie mehr: [Confartigianato Vicenza - FuturCRAFT](https://www.confartigianatovicenza.it/futurcraft/)""",
...
"it": """
**⚠ NOTA BENE: I dati relativi alla valutazione digitale delle aziende austriache sono molto generici e non riferibili alla sola Regione di Salisburgo. Pertanto, non possono essere messi a confronto con quelli delle aziende italiane e integrati nell’infografica.**

L’offerta formativa nel territorio di Salisburgo è simile a quella di Treviso e Belluno. È previsto lo sviluppo delle competenze seguenti ma non in tutte le scuole coinvolte:  *Cloud Manufacturing* in 3 scuole, *Advanced Automation* in 5, *Industrial Analytics* in 2, *Industrial IoT* in 4, *Advanced HMI* (Interfaccia Uomo-Macchina Avanzata) in 2, e *Additive Manufacturing* (Produzione Additiva) in 3.

**Additive Manufacturing**

Nel 2017, il 4% delle imprese austriache ha utilizzato la stampa 3D (utilizzando le proprie stampanti 3D o le stampanti 3D di altre aziende). Nello specifico, l'8% delle aziende che hanno utilizzato la stampa 3D apparteneva al settore della produzione; il 3%, invece, al settore dei servizi. L'84% delle aziende la usava per scopi interni, mentre il 50% per la vendita. 

**Advanced HMI**

Nel 2020, quasi un terzo delle aziende austriache ha utilizzato dispositivi o sistemi intelligenti (32%). Il più delle volte, questi sono utilizzati nella gestione dell'energia per ottimizzare il consumo energetico, ad esempio sotto forma di contatori intelligenti, lampade o termostati (19%). L'11% delle aziende ha utilizzato dispositivi o sistemi intelligenti per il trasporto (ad esempio, con sensori di movimento per registrare il movimento dei veicoli o dei prodotti) o per la manutenzione (ad esempio, con sensori di manutenzione per la manutenzione basata sulle necessità di veicoli o macchine). In generale: più grande è l'azienda, più è probabile che vengano utilizzati dispositivi o sistemi intelligenti.

**Industrial IoT**

Nella regione DACH, sempre più aziende stanno beneficiando dell'IoT, come mostra lo studio "Internet of things 2019/2020". Il 51% delle 444 aziende intervistate ha già implementato progetti IoT, il 93% dei quali è stato valutato come soddisfacente. E anche la sicurezza (informatica) gioca un ruolo importante in questo contesto.

**Industrial Analytics**

Con l'aumento dei dispositivi e dei sistemi digitali, vi è anche un incremento nella quantità di dati. Per rendere disponibile in diverse strutture e utile per l'azienda tale quantità di dati in rapida crescita, è necessaria un'infrastruttura che permetta l'analisi dei big data. Il 9% delle aziende esegue tali analisi sui dati aziendali interni. Nel 7% delle aziende, queste analisi vengono effettuate dai propri dipendenti, mentre il 4% si avvale di aziende esterne per farlo. A questo proposito, le piccole aziende non possono mostrare gli stessi tassi di utilizzo delle aziende più grandi.

**Advanced automation**

Il 5% delle aziende utilizza robot industriali fissi per i processi di produzione, che sono generalmente più utilizzati per la produzione di beni (23%). I robot di servizio autonomi sono usati nel 2% delle aziende. Qui la dimensione dell'azienda gioca un ruolo importante.

**Cloud Manufacturing**

Secondo Statistics Austria, il 38% delle aziende austriache usa servizi cloud. Anche il numero medio di servizi che le aziende usano su Internet è aumentato nel corso degli anni. Inoltre, nel 2020, un terzo delle aziende (32%) ha fatto affidamento su dispositivi o sistemi intelligenti in almeno una delle loro aree di business - ad esempio, su contatori intelligenti, sensori di manutenzione intelligenti per macchine e veicoli o su sensori per l'automazione dei processi di logistica o produzione.
